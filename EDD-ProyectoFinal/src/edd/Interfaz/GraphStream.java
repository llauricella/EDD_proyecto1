...
/**
 * Clase que contiene al objeto de tipo grafo a mostrar en la interfaz.
 * 
 * @version 27/10/2024
...
public class GraphStream extends JFrame implements ViewerListener {
    ...
    /***
     * Procedimiento de inicialización del grafo visual.
     * Colocando a sus respectivos nodos y aristas.
     */
    ...
    /***
     * Procedimiento para mostrar el grafo en pantalla.
     */
    private void run() {
    ...
    /**
     * Procedimiento que cambia el objeto grafo a mostrar de la clase
     * 
     * @param graphstream El nuevo grafo a mostrar
     */
    ...
    /**
     * Función que devuelve el objeto grafo actual de la clase
     * 
     * @return Grafo actual
     */
    ...
    /**
     * Procedimiento que cambia el objeto grafo actual de la clase
     * 
     * @param grafo Nuevo grafo
     */
